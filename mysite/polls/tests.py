...
def create_question(question_text, days):
    ...
    number of 'days' offset to now (negative for questions in the past, 
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        # Question with pub_date in future aren't displayed on index page.
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_future_question(self):
        # The detail view of a question with pub_date in future returns 404.
    ...
    def test_past_question(self):
        # The detail view of a question with pub_date in pas displays question
        # text
